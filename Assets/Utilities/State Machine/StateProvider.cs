...
/// </summary>
public class StateProvider : StateMachineBehaviour
{
    ...
    public override void OnStateEnter( Animator animator, AnimatorStateInfo stateInfo, int layerIndex )
    {
        ...
        if ( StateMachine != null )
        {
            ...
            {
                Debug.Log( "OnStateEnter: " + this, this );
            }
        }
        else
        {
            // If StateMachine is still null then we have a problem.
            Debug.LogError( "State requires a StateMachine to support control context callbacks! Control contest events will not be emitted and OnControlEnter(), OnControlUpdate() and OnControlExit() will not be called until a StateMachine is available.", this );
            return;
        }
    ...
    public virtual void OnControlEnter( Animator animator, AnimatorStateInfo stateInfo, int layerIndex )
    {
        ...
        if ( StateMachine.IsDebugLogging )
        {
            Debug.Log( "OnControlEnter: " + this, this );
        }
    }
    ...
    public override void OnStateUpdate( Animator animator, AnimatorStateInfo stateInfo, int layerIndex )
    {
        ...
        if ( StateMachine != null )
        {
            if ( StateMachine.IsDebugLogging )
            {
                Debug.Log( "OnStateUpdate: " + this, this );
            }
    ...
    public virtual void OnControlUpdate( Animator animator, AnimatorStateInfo stateInfo, int layerIndex )
    {
        ...
        if ( StateMachine.IsDebugLogging )
        {
            Debug.Log( "OnControlUpdate: " + this, this );
        }
    }
    ...
    public override void OnStateExit( Animator animator, AnimatorStateInfo stateInfo, int layerIndex )
    {
        ...
        if ( StateMachine != null )
        {
            if ( StateMachine.IsDebugLogging )
            {
                Debug.Log( "OnStateExit: " + this, this );
            }
    ...
    public virtual void OnControlExit( Animator animator, AnimatorStateInfo stateInfo, int layerIndex )
    {
        ...
        if ( StateMachine.IsDebugLogging )
        {
            Debug.Log( "OnControlExit: " + this, this );
        }
    }
